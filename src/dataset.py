...
def process_data(cfg: Dict[str, Any]):
    ...
    try:
        ...
        logger.success(f"Data loaded successfully (shape: {df.shape}), Index_column : {col_id}")
    ...
    try:
        ...
        X_train, X_test, y_train, y_test = train_test_split(x, y, test_size=cfg["data"]["test_size"], random_state=cfg["data"]["random_state"])
